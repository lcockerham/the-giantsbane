...
7.  False Tomb
    ...
    -   Threats:
        ...
        **Duration**: Instantaneous
        ...
        Any creature attempting to remove the lid triggers a _**burning hands**_ spell in the direction of the creature. Each creature in a 15-foot cone from the triggering creature makes a DC 11 Dexterity saving throw, taking 10 (3d6) damage on a failed save, or half as much damage on a successful one.

        **Detect and Disarm**: As a Search action, a creature can examine the lid and make a DC 11 Wisdom (Perception) check to detect the magical rune that triggers the trap. It can only be deactivated via a _**dispel magic**_.
    ...
    -   Developments:
        ...
        -   Green Lantern: This lantern contains a torch that has a _**continual flame**_ cast on it. When the sarcophagus points at it, the elevator collapses, and two **swarms of larvae** climb out and attack the nearest PC. Characters can easily climb down the pitted passage to area 15.
...
9.  Architect's Foyer
    ...
    -   Summary: A large stone blocks this passage with only a thin space between the stone and the ceiling for someone to squeeze through. The stone can be tipped, springing a trap.
...
10. Passage of Honor
    ...
    -   Threats: A [choker](https://www.dndbeyond.com/monsters/2560754-choker) hides in the second set of alcoves.
...
13. Workshop
    ...
    -   Threats: If touched, the elemental creature that looks like an egg awakens and challenges the party in Terran. If convinced the characters can help it escape, it relates what it knows about the cavern. If they anger it, it attacks as a **gargoyle** without _**flyby attack**_.
...
16. Food Room/The Hive
    ...
    -   Treasure: Each seeker corpse has a _**potion of healing.**_
...
19. Submerged Shadows

    -   Summary: A submerged bathing room controlled by a corrupted water elemental. Areas 19-22 are submerged. [Underwater combat](https://www.dndbeyond.com/sources/dnd/phb-2014/combat#UnderwaterCombat)
...
21. Other Locker Room with Benches
    ...
    -   Treasure: 55 sp, 38 gp, and 2 pp on Uluvant's body, as well as his seeker ring, worth 200 gp.
...
23. Alastor's Haunt
    ...
    -   Threats: A **grick** lurks amongst the balls. Alastor Land is a **ghost** the party should negotiate with rather than fight.
        ...
        **Duration**: Instantaneous
        ...
        When the trap is triggered, a hail of iron balls fires at anyone standing in the room on the balance beam. Ranged +3 to attack, 1d4 damage, and the target must make a DC 12 Dexterity saving throw or fall into the balls below, taking 1d6 falling damage.
...
24. The Chamber of Sighs
    ...
    -   Threats: Use the **helmed horror** stat block for the wind warriors with the suggested resistances. In addition, the helmed horror can cast _**thunderwave**_ 1/day with a spell save DC of 14, and their arcane swords do thunder instead of force damage.
...
25. The True Tomb
    ...
    -   Checks: DC 15 Intelligence (Arcana) to identify the sphere and the _**talisman of the sphere.**_
    -   Treasure: A _**headband of Intellect**_ (rather than a circlet of wisdom) is waiting for the characters inside the tomb. There are also two long black horns tipped in red worth 50 gp each, as well as a demonic metal box containing an inactive _**Talisman of the Sphere**_.
