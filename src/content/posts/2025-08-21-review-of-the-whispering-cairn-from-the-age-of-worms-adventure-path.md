...
I’m running the campaign in 5e and doing the conversion myself. I generally set skill checks at DC 10 + level for moderately difficult tasks, and adjust from there. We are using 2024 rules for characters and 2024 monsters wherever I can. You can find my session 0 here. I am running for a group of 4 to 6, and playing hybrid with 3 in-person and 3 remote using Vorpal Board. I’m using a lot of terrain and miniatures for the game, and I will include some pics of my setups.

My players know I like making combats challenging, and I warned them there would be a lot of traps, some of which might feel a little unfair by 5e standards (ie, you make a bad decision, you might just die, no saving throw allowed). This is a good and important primer for any game, but especially this AP as written. In general, as I will explain later, the adventure does a very good job of giving clues about dangerous traps, so it feels completely fair. So sadly, no characters were killed as a result of this playthrough, despite my best efforts.

Lastly, I’ve DMed since 1997 and have written a number of my own adventures, some you can see listed on the right. I’ve also broken down a lot of adventures and created guides to aid in running them. My follow-ups to this post will include my notes for running the adventure.
...
Of course, that is easier said than done, as the bodies have been dug up and an angry owlbear has been left behind. The party can defeat the owlbear and adopt its cub. As an animal lover, this feels a little gross to me, but so many parties will love a baby owlbear and not be remotely bothered by slaying its mom. So it is worth keeping it in the adventure, just be forewarned if that could be an issue for anyone. From the farm, it's simple to go back into town and find the local seedy establishment. I don’t remotely like the idea of a dog-fighting arena, so I changed it to cock fighting instead. I still don’t like it, but it does set the feel of the town, and I avoided anything to do with the actual animal cruelty beyond scene setting. Know your group and make sure no one will have issues with this - I was aware I would probably be the most squemish about this, so I felt glossing over it as a scene setting device would be ok with everyone else if it was ok with me. This turned into a good role-play encounter to scare the graverobbers into outing where they took the bodies. My group's approach was _“Hey, tough albino orc, we have the owlbear that killed your buddy outside. Maybe you should spill the beans.”_ A fight works as well.

Once you get the location the graverobbers dropped the bodies, it's easy to go to the observatory. It made for a good cliffhanger to end with the characters encountering Filge in his operating room. There, the characters should get their first big lore dump, and can return to the tomb to finish the adventure.

We played the adventure in four 2-3 hour sessions:

-   Session 0 introduction and the first part of the Cairn
-   Session 1: exploring the areas connected to the False Tomb
-   Session 2: reaching the ghost and blocked door, then finding the grave robbers, and ending with the confrontation with Filge
-   Session 3 was the combat with Filge, and returning to the tomb to explore the true tomb.
...
Many of the traps as designed are going to be lethal at first level, but it's ok because a smart, observant party will identify them all. They correctly identified the crushing elevator by the remains inside, and quickly noped out of the face with the open mouth realizing it's a long fall behind them. My party was prepared, cautious, and experienced, so it played excellently. I could see a less experienced party having a poor experience.

Another highlight was the underwater area in the Lair of the Laborers. It made the fights feel much more dangerous, even if dnd’s holding your breath rules aren’t very realistic. Characters still would run up for air in the middle of the fight, and the fight with the ghouls 120 feet from air was much more nerve-racking for the players than it would have been otherwise.
